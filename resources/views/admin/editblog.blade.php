  ...
  <body>
            ...
            <div class="box-padding">
                <form action="{{route('updateblog')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value="{{old('title',$blog->title)}}" id="blogtitle" placeholder="Enter Your Blog Title">
                    @error('title')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="slug" id="blogslug" value="{{old('slug',$blog->slug)}}" readonly>
                    @error('slug')
                      <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{old('description',$blog->description)}}" name="description" id="blogdescription" placeholder="Enter Short Description For Your Blog">
                    @error('description')
                      <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="writer" id="blogwriter" class="form-control" value="{{old('writer',$blog->writer)}}">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="category" id="blogcategory" class="form-control" value="{{old('category',$blog->category)}}">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="blog" class="ckeditor-classic" rows="15" >{{old('blog',$blog->blog)}}</textarea>
                    @error('blog')
                    <span class="text-danger">{{$message}}</span>
                   @enderror
                  </div>
    ...
    <script>
      ...
      <script>
        ...
        $('#blogcategory').val('{{old('category',$blog->category)}}');
        $('#blogwriter').val('{{old('writer',$blog->writer)}}');
